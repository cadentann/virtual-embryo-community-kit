...
The closeout G2/G3 check on 2026-09-11 used the available local Python runtime and ran 31 tests successfully. It includes actual h5py malformed categorical fixtures and CLI report checks; see the closeout audit evidence for exact environment details and limits.
...
The local Jupyter notebook remains the only supported notebook path. Colab is not assessed or supported in this candidate.
